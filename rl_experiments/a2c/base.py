...
class BaseAlgo(ABC):
    ...
    def collect_experiences(self):
        ...
        exps = DictList()
        # Reshape observations from [num_frames_per_proc][num_procs] to a flat list of
        # [num_frames_per_proc * num_procs] where observations are ordered as:
        # [proc1_frame1, proc2_frame1, ..., procN_frame1, proc1_frame2, proc2_frame2, ...]
        exps.obs = [
            self.obss[i][j]
